...
For verifications: destination and activity names must be strings that are greater than zero characters. Activities have a price (integer), length of time anticipated (integer), and whether or not it needs to be booked in advance (string).
